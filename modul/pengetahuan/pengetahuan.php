...
switch($_GET[act]){
  ...
  case "tambahpengetahuan":
	echo "	<div class='alert alert-success alert-dismissible'>
                ...
                Silahkan pilih gejala yang sesuai dengan jenis kulit yang ada, dan berikan <b>nilai MB & MD</b> dengan cakupan sebagai berikut:<br><br>
				<b>1.0</b> (Pasti Ya)&nbsp;&nbsp;|&nbsp;&nbsp;<b>0.8</b> (Hampir Pasti)&nbsp;&nbsp;|<br>
				<b>0.6</b> (Kemungkinan Besar Ya)&nbsp;&nbsp;|&nbsp;&nbsp;<b>0.4</b> (Mungkin)&nbsp;&nbsp;|<br>
				<b>0.2 sampai -0.2</b> (Tidak Tahu)&nbsp;&nbsp;|&nbsp;&nbsp;<b><br><br>
				...
				<b>Contoh:</b><br>
				Jika kepercayaan <b>(MB)</b> anda terhadap gejala Kulit terlihat bercahaya adalah <b>0.8 (Hampir Pasti)</b><br>
				Dan ketidakpercayaan <b>(MD)</b> anda terhadap gejala Kulit terlihat bercahaya adalah <b>0.2 (Tidak Tahu)</b><br><br>
				<b>Maka:</b> CF(Pakar) = MB – MD (0.8 - 0.2) = <b>0.6</b> <br>
				Dimana nilai kepastian anda terhadap gejala Kulit terlihat bercahaya adalah <b>0.6 (Kemungkinan Besar)</b>
              </div>
		...
		echo	"</select></td></tr>
		<tr><td>Nilai MB</td><td><input autocomplete='off' placeholder='Masukkan Nilai MB' type=text class='form-control' name='nilai_mb' size=20 ></td></tr>
		<tr><td>Nilai MD</td><td><input autocomplete='off' placeholder='Masukkan Nilai MD' type=text class='form-control' name='nilai_md' size=20 ></td></tr>
  ...
  case "editpengetahuan":
	...
	<form name=text_form method=POST action='$aksi?module=pengetahuan&act=update' onsubmit='return Blank_TextField_Validator()'>
		...
		echo	"</select></td></tr>
		<tr><td>Nilai MB</td><td><input autocomplete='off' placeholder='Masukkan NIlai MB' type=text class='form-control' name='nilai_mb' size=20 value='$r[nilai_mb]'></td></tr>
		<tr><td>Nilai MD</td><td><input autocomplete='off' placeholder='Masukkan Nilai MD' type=text class='form-control' name='nilai_md' size=20 value='$r[nilai_md]'></td></tr>
          <tr><td></td><td><input class='btn btn-success' type=submit name=submit value='Simpan' >
		  <input class='btn btn-danger' type=button name=batal value='Batal' onclick=\"window.location.href='?module=pengetahuan';\"></td></tr>
          </table></form>";
    break;  
