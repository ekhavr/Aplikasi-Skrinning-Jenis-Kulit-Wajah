...
switch ($_GET[act]) {
    ...
    case "tambahpost":
        echo "<form name=text_form method=POST action='$aksi?module=post&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Deskripsi Post</td><td> <textarea id='editor1' rows='4' cols='50' class='form-control' name='des_post' type=text placeholder='Masukkan deskripsi post baru...'></textarea></td></tr>
		  <tr><td width=120>Saran Post</td><td><textarea id='editor2' rows='4' cols='50' class='form-control' name='saran_post' type=text placeholder='Masukkan saran post baru...'></textarea></td></tr>
    ...
    case "editpost":
        ...
        echo "<form name=text_form method=POST action='$aksi?module=post&act=update' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Deskripsi Post</td><td><textarea id='editor1' rows='4' cols='50' type=text class='form-control' name='des_post'>$r[des_post]</textarea></td></tr>
		  <tr><td width=120>Saran Post</td><td><textarea id='editor2' rows='4' cols='50' type=text class='form-control' name='saran_post'>$r[saran_post]</textarea></td></tr>
